...
export class NotifyApplication extends BootMixin(
  ...
  this.component(NotificationServiceComponent);
    ...
    this.bind(NodemailerBindings.Config).to({
      ...
      port: 587,
      auth: {
          user: 'abhisheksingh55568@gmail.com',
          pass: 'alqp uwvz ctof nrbu'
      },
    ...
    // this.bind(NotificationBindings.NotificationProvider).toProvider(NotificationProvider)
